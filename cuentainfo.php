...
// PHPMaker 6 configuration for Table cuenta
$cuenta = NULL; // Initialize table object
...
class ccuenta {
	...
	function ccuenta() {
		...
		$this->idCuenta = new cField('cuenta', 'x_idCuenta', 'idCuenta', "`idCuenta`", 3, -1, FALSE);
		$this->fields['idCuenta'] =& $this->idCuenta;
		$this->cuenta = new cField('cuenta', 'x_cuenta', 'cuenta', "`cuenta`", 200, -1, FALSE);
		$this->fields['cuenta'] =& $this->cuenta;
		$this->porcentaje = new cField('cuenta', 'x_porcentaje', 'porcentaje', "`porcentaje`", 4, -1, FALSE);
		$this->fields['porcentaje'] =& $this->porcentaje;
		$this->estado = new cField('cuenta', 'x_estado', 'estado', "`estado`", 3, -1, FALSE);
		$this->fields['estado'] =& $this->estado;
		$this->fechaCreacion = new cField('cuenta', 'x_fechaCreacion', 'fechaCreacion', "`fechaCreacion`", 135, 7, FALSE);
		$this->fields['fechaCreacion'] =& $this->fechaCreacion;
		$this->fechaModificacion = new cField('cuenta', 'x_fechaModificacion', 'fechaModificacion', "`fechaModificacion`", 135, 7, FALSE);
	...
	function DeleteSQL(&$rs) {
		//$SQL = "DELETE FROM `cuenta` WHERE ";
            $SQL = "UPDATE cuenta SET estado=0 where idCuenta =  ".ew_QuotedValue($rs['idCuenta'], $this->idCuenta->FldDataType) ;
//		$SQL .= EW_DB_QUOTE_START . 'idCuenta' . EW_DB_QUOTE_END . '=' .	ew_QuotedValue($rs['idCuenta'], $this->idCuenta->FldDataType) . ' AND ';
...
//		if ($this->CurrentFilter <> "")	$SQL .= " AND " . $this->CurrentFilter;
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("cuentaview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "cuentaadd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("cuentaedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("cuentaadd.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=cuenta" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
